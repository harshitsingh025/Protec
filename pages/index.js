  ...
  return (
    <main className='content'>
        ...
        <div className='owl-carousel owl-theme banner-carousel'>
          <div className='item banner-item1'>
            ...
            <div className='cover'>
              <div className='container-fluid'>
                <div className='row align-items-center align-items-center'>
                  <div className='col-xl-4 col-lg-4 col-md-4 contentLeft'>
                    ...
                    <button type='button' className='btn hvr-fade goProduct'>
                      Read More
                    </button>
                  </div>
                  <div className='col-xl-8 col-lg-8 col-md-8 contentRight'>
                    <img
                      src='img/slide1-product.png'
              ...
              <div className='balls'>
                <img
                  src='img/slide1Ball1.svg'
                  className='img-fluid slideBall1'
                />
                <img
                  src='img/slide1Ball2.svg'
                  className='img-fluid slideBall2'
                />
                <img
                  src='img/slide1Ball3.svg'
                  className='img-fluid slideBall3'
                />
                <img
                  src='img/slide1Ball4.svg'
                  className='img-fluid slideBall4'
                />
              </div>
            </div>
          </div>
          <div className='item banner-item2'>
            ...
            <div className='cover'>
              <div className='container-fluid'>
                <div className='row align-items-center align-items-center'>
                  <div className='col-lg-4 contentLeft'>
                    <h2>Ceramic</h2>
                    <p>
                      Lorem Ipsum is simply dummy text of the printing and
                      typesetting industry. Lorem Ipsum has been the industry’s
                    ...
                    <a href='ceramic.html' className='btn hvr-fade'>
                      Read More
                    </a>
                  </div>
                  <div className='col-lg-5 contentCenter px-md-5'>
                    <img src='img/homeProduct1.png' className='img-fluid' />
                  </div>
                  <div className='col-lg-3 contentRight align-self-end'>
                    <h2>Shield</h2>
                  </div>
                </div>
              </div>
              ...
              <div className='container-fluid'>
                <div className='row align-items-center align-items-center'>
                  <div className='col-lg-4 contentLeft'>
                    ...
                    <a href='microfiber-cloth.html' className='btn hvr-fade'>
                      Read More
                    </a>
                  </div>
                  <div className='col-lg-5 contentCenter align-self-end'>
            ...
            <div className='cover'>
              <div className='container-fluid'>
                <div className='row align-items-center align-items-end'>
                  <div className='col-lg-5 contentLeft align-self-end'>
                    <img
                      src='img/slide4-product.png'
                      className='img-fluid mt-md-5'
                    />
                  </div>
                  <div className='col-lg-4 contentRight align-self-center'>
                    <h2>
                      Paint <span>Protection Film</span>
                    </h2>
                    <p>
                      Lorem Ipsum is simply dummy text of the printing and
                      typesetting industry. Lorem Ipsum has been the industry’s
                    ...
                    <a href='paint-protection.html' className='btn hvr-fade'>
                      Read More
                    </a>
                  </div>
                </div>
      ...
      <section className='secHomeProduct'>
        <div className='lax whyRightImg'>
          <img src='img/productText.svg' className='img-fluid' />
        </div>
        <div className='container'>
          <div className='row align-items-center justify-content-center mb-md-5 pt-md-5'>
            ...
            <div className='co-xl-4 col-lg-4 col-md-6 col-sm-12'>
              <div className='lax productLax'>
                <img src='img/homeProduct1.png' className='img-fluid' />
              </div>
              <div className='lax homeCeramic1'>
                <img src='img/aboutIcon3.png' className='img-fluid' />
              </div>
              <div className='lax homeCeramic2'>
                <img src='img/aboutIcon2.png' className='img-fluid' />
              </div>
              <div className='lax homeCeramic3'>
                <img src='img/aboutIcon1.png' className='img-fluid' />
              </div>
            </div>
          </div>
          <div className='row align-items-center justify-content-center mb-md-5'>
            <div className='co-xl-4 col-lg-4 col-md-6 col-sm-12 text-center'>
              <div style={{ display: 'flex' }}>
                <div className='lax productImg1'>
                  <img
                    src='img/Vertical-S2.png'
                    className='img-fluid'
              ...
              <div className='lax homeCeramic4'>
                <img src='img/aboutIcon4.png' className='img-fluid' />
              </div>
              <div className='lax homeCeramic5'>
                <img src='img/aboutIcon5.png' className='img-fluid' />
              </div>
            </div>
            <div className='co-xl-6 col-lg-6 col-md-6 col-sm-12'>
              <div className='headShadow'>
