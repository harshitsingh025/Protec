              ...
              <div className="container-fluid">
                <div className="row align-items-center align-items-center">                    
                  <div className="col-xl-4 col-lg-4 col-md-4 contentLeft">
                    ...
                    <button type="button" className="btn hvr-fade goProduct">Read More</button>
                  </div>
              ...
              <div className="container-fluid">
                <div className="row align-items-center align-items-center">                    
                  <div className="col-lg-4 contentLeft">
                    <h2>Ceramic</h2>
                    <p>Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry’s standard dummy text ever since the 1500s</p>
                    <a href="ceramic.html" className="btn hvr-fade">Read More</a>
                  </div>
              ...
              <div className="container-fluid">
                <div className="row align-items-center align-items-center">                    
                  <div className="col-lg-4 contentLeft">
                    <h2>Microfiber</h2>
                    <p>Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry’s standard dummy text ever since the 1500s</p>
                    <a href="microfiber-cloth.html" className="btn hvr-fade">Read More</a>
                  </div>
              ...
              <div className="container-fluid">
                <div className="row align-items-center align-items-end">  
                  <div className="col-lg-5 contentLeft align-self-end">                      
                    <img src="img/slide4-product.png" className="img-fluid mt-md-5" />                    
                  </div>                  
                  <div className="col-lg-4 contentRight align-self-center">
                    <h2>Paint <span>Protection Film</span></h2>
                    <p>Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry’s standard dummy text ever since the 1500s</p>
                    <a href="paint-protection.html" className="btn hvr-fade">Read More</a>
                  </div>
                </div>
              </div>
            </div>
