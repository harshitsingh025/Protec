        ...
        <div className="productWrapper">
          ...
          <section className="secCategory">
            ...
            <nav className="category-nav">
              ...
              <div className="nav nav-tabs category-tabs justify-content-center" id="nav-tab" role="tablist">
                <a href="ceramic.html" className="nav-item nav-link active">Ceramic shield</a>
                <a href="leather-ceramic.html" className="nav-item nav-link">leather ceramic</a>
                <a href="plastic-ceramic.html" className="nav-item nav-link">Plastic ceramic</a>
                <a href="glass-ceramic.html" className="nav-item nav-link">glass ceramic</a>
              </div>
            </nav>
            <div className="tab-content" id="nav-tabContent">
              <div className="tab-pane fade show active" id="nav-series2" role="tabpanel" aria-labelledby="nav-series2-tab">                <div className="container">
                  <img src="img/ceramicText.svg" className="img-fluid my-md-5" />     
              ...
              <div className="row justify-content-center align-items-center">
                <div className="col-xl-10 col-lg-10 col-md-12">
                  ...
                  <OwlCarousel className='owl-theme' loop margin={40} nav items={3} dots={false}>
                    ...
                    <div className='item'>
                      <a href="plastic-ceramic.html" className="relatedPBox">
                        <div className="relatedPImg">
